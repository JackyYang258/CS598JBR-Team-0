...
input_dataset = "CS598JBR-Team-0/selected_humaneval_140775227846220186319649371072416763498.jsonl"# selected_humaneval_[seed].jsonl

# Set up requirements for model prompting
! bash -x MP2/setup_models.sh

# TODO: add your seed generated in MP1
seed = "140775227846220186319649371072416763498"
task_1_vanilla_json = "task_1_" + seed + "_vanilla.jsonl" 
# "task_1_140775227846220186319649371072416763498_vanilla.jsonl"
...
! python3 task_1.py {input_dataset} "deepseek-ai/deepseek-coder-6.7b-instruct" {task_1_crafted_json} "True" |& tee task_1_vanilla.log
